...
class ObserverMakeCommand extends Command
{
    ...
    protected $signature = 'make:observer
                            ...
                            {--p|provider : Creates the events eloquent service provider for observers}
    ';
            ...
            $replacement = str_replace("public function boot()
    {
        ...
        $defaultObserverContent = File::get(app_path('/Console/Commands/Stubs/DummyObserver.stub'));
        $runtimeObserverContent = str_replace('Dummy', $model, $defaultObserverContent);
        File::put(app_path('/Console/Commands/Stubs/DummyObserver.stub'), $runtimeObserverContent);
        File::copy(app_path('/Console/Commands/Stubs/DummyObserver.stub'), app_path('/Observers/' . $name . '.php'));
        File::put(app_path('/Console/Commands/Stubs/DummyObserver.stub'), $defaultObserverContent);
